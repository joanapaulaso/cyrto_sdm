...
# WorldClim
bio1 <- raster("./VAR/HIGHRES/wc2.1_30s_bio_1.tif")
bio2 <- raster("./VAR/HIGHRES/wc2.1_30s_bio_2.tif")
bio3 <- raster("./VAR/HIGHRES/wc2.1_30s_bio_3.tif")
bio4 <- raster("./VAR/HIGHRES/wc2.1_30s_bio_4.tif")
bio5 <- raster("./VAR/HIGHRES/wc2.1_30s_bio_5.tif")
bio6 <- raster("./VAR/HIGHRES/wc2.1_30s_bio_6.tif")
bio7 <- raster("./VAR/HIGHRES/wc2.1_30s_bio_7.tif")
bio8 <- raster("./VAR/HIGHRES/wc2.1_30s_bio_8.tif")
bio9 <- raster("./VAR/HIGHRES/wc2.1_30s_bio_9.tif")
bio10 <- raster("./VAR/HIGHRES/wc2.1_30s_bio_10.tif")
bio11 <- raster("./VAR/HIGHRES/wc2.1_30s_bio_11.tif")
bio12 <- raster("./VAR/HIGHRES/wc2.1_30s_bio_12.tif")
bio13 <- raster("./VAR/HIGHRES/wc2.1_30s_bio_13.tif")
bio14 <- raster("./VAR/HIGHRES/wc2.1_30s_bio_14.tif")
bio15 <- raster("./VAR/HIGHRES/wc2.1_30s_bio_15.tif")
bio16 <- raster("./VAR/HIGHRES/wc2.1_30s_bio_16.tif")
bio17 <- raster("./VAR/HIGHRES/wc2.1_30s_bio_17.tif")
bio18 <- raster("./VAR/HIGHRES/wc2.1_30s_bio_18.tif")
bio19 <- raster("./VAR/HIGHRES/wc2.1_30s_bio_19.tif")
prec <- raster("./VAR/HIGHRES/PREC_MEAN.tif")
srad <- raster("./VAR/HIGHRES/SRAD_MEAN.tif")
tavg <- raster("./VAR/HIGHRES/TAVG_MEAN.tif")
vapr <- raster("./VAR/HIGHRES/VAPR_MEAN.tif")
wind <- raster("./VAR/HIGHRES/WIND_MEAN.tif")


# Cloud cover MODCF
cc1 <- raster("./VAR/HIGHRES/MODCF_intraannualSD.tif")
cc2 <- raster("./VAR/HIGHRES/MODCF_monthlymean_01.tif")
cc3 <- raster("./VAR/HIGHRES/MODCF_monthlymean_07.tif")

# NDVI 2003-2007
ndvi1 <- raster("./VAR/HIGHRES/NDVI_CUM_2003-2007.tif")
ndvi2 <- raster("./VAR/HIGHRES/NDVI_MIN_2003-2007.tif")
ndvi3 <- raster("./VAR/HIGHRES/NDVI_SEAS_2003-2007.tif")

# SoilGrids
soil1 <- raster("./VAR/HIGHRES/CEC.tif") # Cation Exchange Capacity of the soil
soil2 <- raster("./VAR/HIGHRES/CFVO.tif") # Volumetric fraction of coarse fragments (> 2 mm)
soil3 <- raster("./VAR/HIGHRES/CLAY.tif")
soil4 <- raster("./VAR/HIGHRES/NITROGEN.tif")
soil5 <- raster("./VAR/HIGHRES/OCD.tif") # Organic carbon density
soil6 <- raster("./VAR/HIGHRES/phh2o.tif")
soil7 <- raster("./VAR/HIGHRES/SAND.tif")
soil8 <- raster("./VAR/HIGHRES/SILT.tif")
soil9 <- raster("./VAR/HIGHRES/SOC.tif") # Soil organic carbon content in the fine earth fraction

# Topography
topo1 <- raster("./VAR/HIGHRES/AI.tif")
topo2 <- raster("./VAR/HIGHRES/aspectcosine.tif")
topo3 <- raster("./VAR/HIGHRES/aspectsine.tif")
topo4 <- raster("./VAR/HIGHRES/CTI.tif")
topo5 <- raster("./VAR/HIGHRES/elevation.tif")
topo6 <- raster("./VAR/HIGHRES/HLI.tif")
topo7 <- raster("./VAR/HIGHRES/slope.tif")
topo8 <- raster("./VAR/HIGHRES/tpi.tif")
topo9 <- raster("./VAR/HIGHRES/vrm.tif")
...
cyrtopodium_matrix <- read.csv("cyrto.csv")
...
# Write thinned records data for ENMTML analysis
...
occ <- "cyrto_ENMTML.txt"
varBio <- "./VAR/Selected-6VAR"
mask <- "./POLYGON/clipped_cg.shp"

# 15 - Call ENMTML for modelling ----
memory.limit(80040)
memory.limit()
...
ENMTML(
  ...
  pseudoabs_method = c(method='GEO_ENV_CONST', width='100'),
  pres_abs_ratio = 0.02,
  part = c(method='BLOCK'),
  save_part = FALSE,
  save_final = TRUE,
